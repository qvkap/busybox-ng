...
int busybox_main(int argc UNUSED_PARAM, char **argv)
{
 ...
 help:
		...
		full_write1_str(
			"BusyBox-ng is a modern fork of BusyBox with various improvements.\n"
...
#  endif
			...
			"\tBusyBox-ng is a multi-call binary that combines many common Unix\n"
			"\tutilities into a single executable.  Most people will create a\n"
			"\tlink to busybox for each function they wish to use and BusyBox-ng\n"

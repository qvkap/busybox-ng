...
IF_UNZSTD(APPLET(unzstd, BB_DIR_USR_BIN, BB_SUID_DROP))
IF_ZSTDCAT(APPLET_ODDNAME(zstdcat, unzstd, BB_DIR_USR_BIN, BB_SUID_DROP, zstdcat))
...
IF_SHA384SUM(APPLET_NOEXEC(sha384sum, md5_sha1_sum, BB_DIR_USR_BIN, BB_SUID_DROP, sha384sum))
...
IF_VI(APPLET_ODDNAME(vim, vi, BB_DIR_USR_BIN, BB_SUID_DROP, vim))
...
IF_KMOD_WRAPPER(APPLET(kmod, BB_DIR_BIN, BB_SUID_DROP))
IF_KMOD_WRAPPER(APPLET_ODDNAME(insmod, kmod, BB_DIR_SBIN, BB_SUID_DROP, insmod))
IF_KMOD_WRAPPER(APPLET_ODDNAME(rmmod, kmod, BB_DIR_SBIN, BB_SUID_DROP, rmmod))
IF_KMOD_WRAPPER(APPLET_ODDNAME(lsmod, kmod, BB_DIR_SBIN, BB_SUID_DROP, lsmod))
IF_KMOD_WRAPPER(APPLET_ODDNAME(modprobe, kmod, BB_DIR_SBIN, BB_SUID_DROP, modprobe))
IF_KMOD_WRAPPER(APPLET_ODDNAME(modinfo, kmod, BB_DIR_SBIN, BB_SUID_DROP, modinfo))
IF_KMOD_WRAPPER(APPLET_ODDNAME(depmod, kmod, BB_DIR_SBIN, BB_SUID_DROP, depmod))
...
IF_CURL(APPLET(curl, BB_DIR_USR_BIN, BB_SUID_DROP))
...
IF_SSL_SERVER(APPLET(ssl_server, BB_DIR_USR_BIN, BB_SUID_DROP))
...
IF_VMSTAT(APPLET(vmstat, BB_DIR_BIN, BB_SUID_DROP))
...
IF_LSBLK(APPLET(lsblk, BB_DIR_USR_BIN, BB_SUID_DROP))
...
IF_UUIDGEN(APPLET_NOFORK(uuidgen, uuidgen, BB_DIR_USR_BIN, BB_SUID_DROP, uuidgen))

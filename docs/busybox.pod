...
C<[>, C<[[>, L<C<acpid>|/"acpid">, L<C<add-shell>|/"add-shell">, L<C<addgroup>|/"addgroup">, L<C<adduser>|/"adduser">, L<C<adjtimex>|/"adjtimex">, L<C<arch>|/"arch">, L<C<arp>|/"arp">,
L<C<arping>|/"arping">, C<ascii>, L<C<awk>|/"awk">, L<C<base32>|/"base32">, L<C<base64>|/"base64">, L<C<basename>|/"basename">, L<C<bc>|/"bc">, L<C<beep>|/"beep">, L<C<blkdiscard>|/"blkdiscard">,
L<C<blkid>|/"blkid">, L<C<blockdev>|/"blockdev">, L<C<bootchartd>|/"bootchartd">, L<C<brctl>|/"brctl">, L<C<bunzip2>|/"bunzip2">, L<C<bzcat>|/"bzcat">, L<C<bzip2>|/"bzip2">, L<C<cal>|/"cal">, L<C<cat>|/"cat">,
L<C<chat>|/"chat">, L<C<chattr>|/"chattr">, L<C<chgrp>|/"chgrp">, L<C<chmod>|/"chmod">, L<C<chown>|/"chown">, L<C<chpasswd>|/"chpasswd">, L<C<chpst>|/"chpst">, L<C<chroot>|/"chroot">, L<C<chrt>|/"chrt">,
L<C<chvt>|/"chvt">, L<C<cksum>|/"cksum">, L<C<clear>|/"clear">, L<C<cmp>|/"cmp">, L<C<comm>|/"comm">, L<C<conspy>|/"conspy">, L<C<cp>|/"cp">, L<C<cpio>|/"cpio">, L<C<crc32>|/"crc32">, L<C<crond>|/"crond">,
L<C<crontab>|/"crontab">, L<C<cryptpw>|/"cryptpw">, L<C<cttyhack>|/"cttyhack">, L<C<curl>|/"curl">, L<C<cut>|/"cut">, L<C<date>|/"date">, L<C<dc>|/"dc">, L<C<dd>|/"dd">, L<C<deallocvt>|/"deallocvt">,
L<C<delgroup>|/"delgroup">, L<C<deluser>|/"deluser">, L<C<depmod>|/"depmod">, L<C<devmem>|/"devmem">, L<C<df>|/"df">, L<C<dhcprelay>|/"dhcprelay">, L<C<diff>|/"diff">, L<C<dirname>|/"dirname">,
L<C<dmesg>|/"dmesg">, L<C<dnsd>|/"dnsd">, C<dnsdomainname>, L<C<dos2unix>|/"dos2unix">, L<C<dpkg>|/"dpkg">, L<C<dpkg-deb>|/"dpkg-deb">, L<C<du>|/"du">, L<C<dumpkmap>|/"dumpkmap">,
L<C<dumpleases>|/"dumpleases">, L<C<echo>|/"echo">, L<C<ed>|/"ed">, C<egrep>, L<C<eject>|/"eject">, L<C<env>|/"env">, L<C<envdir>|/"envdir">, L<C<envuidgid>|/"envuidgid">,
L<C<ether-wake>|/"ether-wake">, L<C<expand>|/"expand">, L<C<expr>|/"expr">, L<C<factor>|/"factor">, L<C<fallocate>|/"fallocate">, C<false>, L<C<fatattr>|/"fatattr">, L<C<fbset>|/"fbset">,
L<C<fbsplash>|/"fbsplash">, L<C<fdflush>|/"fdflush">, L<C<fdformat>|/"fdformat">, L<C<fdisk>|/"fdisk">, L<C<fgconsole>|/"fgconsole">, C<fgrep>, L<C<find>|/"find">, L<C<findfs>|/"findfs">,
L<C<flock>|/"flock">, L<C<fold>|/"fold">, L<C<free>|/"free">, L<C<freeramdisk>|/"freeramdisk">, L<C<fsck>|/"fsck">, L<C<fsck.minix>|/"fsck.minix">, L<C<fsfreeze>|/"fsfreeze">, L<C<fstrim>|/"fstrim">,
L<C<fsync>|/"fsync">, L<C<ftpd>|/"ftpd">, L<C<ftpget>|/"ftpget">, L<C<ftpput>|/"ftpput">, L<C<fuser>|/"fuser">, L<C<getfattr>|/"getfattr">, L<C<getopt>|/"getopt">, L<C<getty>|/"getty">, L<C<grep>|/"grep">,
L<C<groups>|/"groups">, L<C<gunzip>|/"gunzip">, L<C<gzip>|/"gzip">, L<C<halt>|/"halt">, L<C<hd>|/"hd">, L<C<hdparm>|/"hdparm">, L<C<head>|/"head">, L<C<hexdump>|/"hexdump">, L<C<hexedit>|/"hexedit">,
L<C<hostid>|/"hostid">, L<C<hostname>|/"hostname">, L<C<httpd>|/"httpd">, L<C<hush>|/"hush">, L<C<hwclock>|/"hwclock">, L<C<i2cdetect>|/"i2cdetect">, L<C<i2cdump>|/"i2cdump">, L<C<i2cget>|/"i2cget">,
L<C<i2cset>|/"i2cset">, L<C<i2ctransfer>|/"i2ctransfer">, L<C<id>|/"id">, L<C<ifconfig>|/"ifconfig">, L<C<ifdown>|/"ifdown">, L<C<ifenslave>|/"ifenslave">, L<C<ifplugd>|/"ifplugd">, L<C<ifup>|/"ifup">,
L<C<inetd>|/"inetd">, L<C<init>|/"init">, L<C<insmod>|/"insmod">, L<C<install>|/"install">, L<C<ionice>|/"ionice">, L<C<iostat>|/"iostat">, L<C<ip>|/"ip">, L<C<ipaddr>|/"ipaddr">, L<C<ipcalc>|/"ipcalc">,
L<C<ipcrm>|/"ipcrm">, L<C<ipcs>|/"ipcs">, L<C<iplink>|/"iplink">, L<C<ipneigh>|/"ipneigh">, L<C<iproute>|/"iproute">, L<C<iprule>|/"iprule">, L<C<iptunnel>|/"iptunnel">, L<C<kbd_mode>|/"kbd_mode">,
L<C<kill>|/"kill">, L<C<killall>|/"killall">, L<C<killall5>|/"killall5">, L<C<klogd>|/"klogd">, L<C<kmod>|/"kmod">, L<C<last>|/"last">, L<C<less>|/"less">, L<C<link>|/"link">, C<linux32>,
C<linux64>, C<linuxrc>, L<C<ln>|/"ln">, L<C<loadfont>|/"loadfont">, L<C<loadkmap>|/"loadkmap">, L<C<logger>|/"logger">, L<C<login>|/"login">, L<C<logname>|/"logname">,
L<C<logread>|/"logread">, L<C<losetup>|/"losetup">, L<C<lpd>|/"lpd">, L<C<lpq>|/"lpq">, L<C<lpr>|/"lpr">, L<C<ls>|/"ls">, L<C<lsattr>|/"lsattr">, L<C<lsblk>|/"lsblk">, L<C<lsmod>|/"lsmod">, L<C<lsof>|/"lsof">,
L<C<lspci>|/"lspci">, C<lsscsi>, C<lsusb>, L<C<lzcat>|/"lzcat">, L<C<lzma>|/"lzma">, L<C<lzop>|/"lzop">, L<C<makedevs>|/"makedevs">, L<C<makemime>|/"makemime">, L<C<man>|/"man">,
L<C<md5sum>|/"md5sum">, L<C<mdev>|/"mdev">, L<C<mesg>|/"mesg">, L<C<microcom>|/"microcom">, L<C<mim>|/"mim">, L<C<mkdir>|/"mkdir">, L<C<mkdosfs>|/"mkdosfs">, L<C<mke2fs>|/"mke2fs">, L<C<mkfifo>|/"mkfifo">,
L<C<mkfs.ext2>|/"mkfs.ext2">, L<C<mkfs.minix>|/"mkfs.minix">, L<C<mkfs.vfat>|/"mkfs.vfat">, L<C<mknod>|/"mknod">, L<C<mkpasswd>|/"mkpasswd">, L<C<mkswap>|/"mkswap">, L<C<mktemp>|/"mktemp">,
L<C<modinfo>|/"modinfo">, L<C<modprobe>|/"modprobe">, L<C<more>|/"more">, L<C<mount>|/"mount">, L<C<mountpoint>|/"mountpoint">, L<C<mpstat>|/"mpstat">, L<C<mt>|/"mt">, L<C<mv>|/"mv">, L<C<nameif>|/"nameif">,
L<C<nanddump>|/"nanddump">, L<C<nandwrite>|/"nandwrite">, L<C<nbd-client>|/"nbd-client">, L<C<nc>|/"nc">, L<C<netstat>|/"netstat">, L<C<nice>|/"nice">, L<C<nl>|/"nl">, L<C<nmeter>|/"nmeter">,
L<C<nohup>|/"nohup">, L<C<nologin>|/"nologin">, L<C<nproc>|/"nproc">, L<C<nsenter>|/"nsenter">, L<C<nslookup>|/"nslookup">, L<C<ntpd>|/"ntpd">, L<C<od>|/"od">, L<C<openvt>|/"openvt">,
L<C<partprobe>|/"partprobe">, L<C<passwd>|/"passwd">, L<C<paste>|/"paste">, L<C<patch>|/"patch">, L<C<pgrep>|/"pgrep">, L<C<pidof>|/"pidof">, L<C<ping>|/"ping">, L<C<ping6>|/"ping6">,
C<pipe_progress>, L<C<pivot_root>|/"pivot_root">, L<C<pkill>|/"pkill">, L<C<pmap>|/"pmap">, L<C<popmaildir>|/"popmaildir">, L<C<poweroff>|/"poweroff">,
L<C<powertop>|/"powertop">, L<C<printenv>|/"printenv">, L<C<printf>|/"printf">, L<C<ps>|/"ps">, L<C<pscan>|/"pscan">, L<C<pstree>|/"pstree">, L<C<pwd>|/"pwd">, L<C<pwdx>|/"pwdx">, L<C<rdate>|/"rdate">,
L<C<readahead>|/"readahead">, L<C<readlink>|/"readlink">, L<C<readprofile>|/"readprofile">, L<C<realpath>|/"realpath">, L<C<reboot>|/"reboot">, L<C<reformime>|/"reformime">,
L<C<remove-shell>|/"remove-shell">, L<C<renice>|/"renice">, L<C<reset>|/"reset">, L<C<resize>|/"resize">, L<C<resume>|/"resume">, L<C<rev>|/"rev">, L<C<rm>|/"rm">, L<C<rmdir>|/"rmdir">, L<C<rmmod>|/"rmmod">,
L<C<route>|/"route">, L<C<rpm>|/"rpm">, L<C<rpm2cpio>|/"rpm2cpio">, L<C<rtcwake>|/"rtcwake">, L<C<run-init>|/"run-init">, L<C<run-parts>|/"run-parts">, L<C<runlevel>|/"runlevel">, L<C<runsv>|/"runsv">,
L<C<runsvdir>|/"runsvdir">, L<C<script>|/"script">, L<C<scriptreplay>|/"scriptreplay">, L<C<sed>|/"sed">, L<C<seedrng>|/"seedrng">, L<C<sendmail>|/"sendmail">, L<C<seq>|/"seq">,
L<C<setarch>|/"setarch">, L<C<setconsole>|/"setconsole">, L<C<setfattr>|/"setfattr">, L<C<setfont>|/"setfont">, L<C<setkeycodes>|/"setkeycodes">, L<C<setlogcons>|/"setlogcons">,
L<C<setpriv>|/"setpriv">, L<C<setserial>|/"setserial">, L<C<setsid>|/"setsid">, L<C<setuidgid>|/"setuidgid">, L<C<sh>|/"sh">, L<C<sha1sum>|/"sha1sum">, L<C<sha256sum>|/"sha256sum">,
L<C<sha384sum>|/"sha384sum">, L<C<sha3sum>|/"sha3sum">, L<C<sha512sum>|/"sha512sum">, L<C<showkey>|/"showkey">, L<C<shred>|/"shred">, L<C<shuf>|/"shuf">, L<C<sleep>|/"sleep">, L<C<smemcap>|/"smemcap">,
L<C<softlimit>|/"softlimit">, L<C<sort>|/"sort">, L<C<split>|/"split">, L<C<ssl_client>|/"ssl_client">, L<C<ssl_server>|/"ssl_server">, L<C<start-stop-daemon>|/"start-stop-daemon">,
L<C<stat>|/"stat">, L<C<strings>|/"strings">, L<C<stty>|/"stty">, L<C<su>|/"su">, L<C<sulogin>|/"sulogin">, L<C<sum>|/"sum">, L<C<sv>|/"sv">, L<C<svc>|/"svc">, L<C<svlogd>|/"svlogd">, L<C<svok>|/"svok">,
L<C<swapoff>|/"swapoff">, L<C<swapon>|/"swapon">, L<C<switch_root>|/"switch_root">, L<C<sync>|/"sync">, L<C<sysctl>|/"sysctl">, L<C<syslogd>|/"syslogd">, L<C<tac>|/"tac">, L<C<tail>|/"tail">, L<C<tar>|/"tar">,
L<C<taskset>|/"taskset">, L<C<tc>|/"tc">, L<C<tcpsvd>|/"tcpsvd">, L<C<tee>|/"tee">, L<C<telnet>|/"telnet">, L<C<telnetd>|/"telnetd">, C<test>, L<C<tftp>|/"tftp">, L<C<tftpd>|/"tftpd">, L<C<time>|/"time">,
L<C<timeout>|/"timeout">, L<C<top>|/"top">, L<C<touch>|/"touch">, L<C<tr>|/"tr">, L<C<traceroute>|/"traceroute">, L<C<traceroute6>|/"traceroute6">, C<tree>, C<true>,
L<C<truncate>|/"truncate">, L<C<ts>|/"ts">, L<C<tsort>|/"tsort">, L<C<tty>|/"tty">, L<C<ttysize>|/"ttysize">, L<C<tunctl>|/"tunctl">, L<C<ubiattach>|/"ubiattach">, L<C<ubidetach>|/"ubidetach">,
L<C<ubimkvol>|/"ubimkvol">, L<C<ubirename>|/"ubirename">, L<C<ubirmvol>|/"ubirmvol">, L<C<ubirsvol>|/"ubirsvol">, L<C<ubiupdatevol>|/"ubiupdatevol">, L<C<udhcpc>|/"udhcpc">,
L<C<udhcpc6>|/"udhcpc6">, L<C<udhcpd>|/"udhcpd">, L<C<udpsvd>|/"udpsvd">, L<C<uevent>|/"uevent">, L<C<umount>|/"umount">, L<C<uname>|/"uname">, L<C<unexpand>|/"unexpand">, L<C<uniq>|/"uniq">,
L<C<unix2dos>|/"unix2dos">, L<C<unlink>|/"unlink">, L<C<unlzma>|/"unlzma">, L<C<unxz>|/"unxz">, L<C<unzip>|/"unzip">, L<C<unzstd>|/"unzstd">, L<C<uptime>|/"uptime">, L<C<users>|/"users">,
L<C<usleep>|/"usleep">, L<C<uudecode>|/"uudecode">, L<C<uuencode>|/"uuencode">, L<C<uuidgen>|/"uuidgen">, L<C<vconfig>|/"vconfig">, L<C<vi>|/"vi">, L<C<vim>|/"vim">, L<C<vlock>|/"vlock">,
L<C<vmstat>|/"vmstat">, L<C<volname>|/"volname">, L<C<w>|/"w">, L<C<wall>|/"wall">, L<C<watch>|/"watch">, L<C<watchdog>|/"watchdog">, L<C<wc>|/"wc">, L<C<wget>|/"wget">, L<C<which>|/"which">, L<C<who>|/"who">,
L<C<whoami>|/"whoami">, L<C<whois>|/"whois">, L<C<xargs>|/"xargs">, L<C<xxd>|/"xxd">, L<C<xz>|/"xz">, L<C<xzcat>|/"xzcat">, L<C<yes>|/"yes">, L<C<zcat>|/"zcat">, L<C<zcip>|/"zcip">, L<C<zstdcat>|/"zstdcat">
...
udhcpc6 [-fbqvR] [-t N] [-T SEC] [-A SEC|-n] [-i IFACE] [-s PROG]
	[-p PIDFILE] [-mldo] [-r IPv6] [-x OPT:VAL]... [-O OPT]...
